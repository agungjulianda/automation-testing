...
class Test_003_navigateCardDetails:
    ...
    def test_navDCM(self,setup):
        self.logger.info
        self.logger.info("***** Test Test_003_Navigate Card Details  ")
        self.logger.info("***** Verifying Navigate Card Details ")
        self.driver = setup
        ...
        try:
            ...
            self.logger.info("***** Navigate Card Details Passed ")
            time.sleep(3)
            self.driver.close()
            ...
            self.logger.error("***** Navigate Card Details Failed ")
